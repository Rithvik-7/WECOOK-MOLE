...
| Team | **WE COOK** · **CMRIT** (not CMIT) · GitHub **WECOOK-MOLE** |
| Members | See `docs/TEAM.md`. Order: **Rithvik** (leader, ISE — AI/ML, website, research, PPT, coordination); **Komala TG** (ISE — shared AI/ML, backend, research, PPT); **Venkatesh** & **Devika** (ISE — ordered and managed all electronics, also backend); **Pragati Karvi** (ISE — frontend, backend, PPT, demo); **Pallavi Samantha** (ISE — research, website, basic electronics). All 2nd year, **CMRIT**. |
