/*
 * MOLE Node B — classic ESP32-WROOM-32 (ESP32 Dev Module)
 * Same as firmware/node/node.ino with NODE_ID 2 and HAS_POT 0.
 *
 * MPU6050: VCC 3V3, GND, SDA 21, SCL 22, AD0 GND (addr 0x68)
 * GPIO34 unused. ESP-NOW broadcast, channel 1.
 */
